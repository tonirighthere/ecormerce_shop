...
function createSearchParamsHelper(filterParams, sort, page) {
  const queryParams = [];
...
function ShoppingListing() {
  ...
  const { productList, productDetails, currentPage, totalPages } = useSelector(
  ...
  useEffect(() => {
    if (filters && Object.keys(filters).length > 0) {
      const createQueryString = createSearchParamsHelper(filters, sort, page);
